...
def estimateF0(inputFile = '../../sounds/cello-double-2.wav'):
    ...
    w  = get_window(window, M, fftbins=False)                   #obtaining analysis window    
...
# f0 = estimateF0("hamming", 17001, 32768, 10, -60)
# f0 = estimateF0("blackmanharris", 13001, 16384, 10, -70)