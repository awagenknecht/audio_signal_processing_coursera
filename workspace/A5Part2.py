...
def chirpTracker(inputFile='../../sounds/chirp-150-190-linear.wav'):
    ...
    # plt.plot(abs(x[5000:-5000] - y[5000:-5000]))
    # plt.show()
...
# # for m in [100*x+1 for x in range(1, 80, 10)]:
# for m in [3400, 6615]:
#     print(m, '\n')
#     M, H, tStamps, fTrackEst, fTrackTrue = chirpTracker(m=m)

# M, H, tStamps, fTrackEst, fTrackTrue = chirpTracker()