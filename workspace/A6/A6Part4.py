...
# computeAndPlotF0(inputFile = '../../sounds/how-long-choir-low-short-mono.wav')

# had trouble finding audio files on freesound that exhibit either of the two described limitations in order to demonstrate improvements
